...
import { ArrowLeftRight, List, PieChart as PieIcon, Users } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard donasi KHOLWAT MDTI 2026 — pantau target, realisasi, dan kontribusi tiap sumber donasi Majelis Dzikir Tasbih Indonesia." },
      { property: "og:title", content: "KHOLWAT MDTI 2026" },
      { property: "og:description", content: "Dashboard donasi Majelis Dzikir Tasbih Indonesia." },
